...
Inputs::Inputs(QWidget *parent) :QWidget(parent)
{
    ...
    QList<MyString*> tempStringhe = QList<MyString*>();
    tempStringhe.append(new MyString());
...
void Inputs::refresh(QList<MyString *> elements, QList<bool> active)
{
    int i = 0;
    QList<MyString*>::iterator it;
